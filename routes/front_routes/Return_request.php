...
Route::delete('retour/supprimer/', [App\Http\Controllers\Return_requestController::class, 'delete'])->name('supprimerReturn_request')->middleware('auth');
...
Route::get('retour/lists', [App\Http\Controllers\Return_requestController::class, 'fetch'])->name('listsReturn_request')->middleware('auth');
